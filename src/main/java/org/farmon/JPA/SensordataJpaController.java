...
public class SensordataJpaController implements Serializable {
    ...
    public SensordataJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Sensordata sensordata) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            if (findSensordata(sensordata.getId()) != null) {
                throw new PreexistingEntityException("Sensordata " + sensordata + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void edit(Sensordata sensordata) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();

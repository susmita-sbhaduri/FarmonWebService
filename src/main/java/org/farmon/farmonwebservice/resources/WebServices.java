...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String editHarvestRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int editres = masterDataService.editHarvestRecord(farmondto.getHarvestrecord());
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
        ...
        List<EmpLeaveDTO> empleaves = masterDataService.getEmpleaveRecords();
        farmondto.setEmpleavelist(empleaves);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
        } catch (JsonProcessingException ex) {
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getPaidEmpLoans(String termDTOJSON) throws NamingException, ParseException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
        ...
        List<EmpExpDTO> activeloans = masterDataService.getEmpPaidLoans();
        farmondto.setEmpexplist(activeloans);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getBuyerList(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        List<BuyerDTO> buyerlist = masterDataService.getBuyerList();
        farmondto.setBuyerlist(buyerlist);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
        } catch (JsonProcessingException ex) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getMaxBuyerId(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        String maxid = String.valueOf(masterDataService.getMaxBuyerId());
        BuyerDTO buyerrec = new BuyerDTO();
        buyerrec.setBuyerId(maxid);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String addBuyerRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int addres = masterDataService.addBuyerRecord(farmondto.getBuyerrec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_ADD_RES(addres);
        farmondto.setResponses(farmonres);
        try {
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String DelShopResid(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int delres = masterDataService.deleteShopResForResid(farmondto.
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getDisShopForResid(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        List<ShopResDTO> shopreslist = masterDataService.getDistinctShopForResid();
        farmondto.setShopreslist(shopreslist);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String editExpenseRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int editres = masterDataService.editExpenseRecord(farmondto.getExpenserec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_EDIT_RES(editres);
        farmondto.setResponses(farmonres);
        try {
    ...
    @Path("getExpenseRefCat")
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getExpenseRefCat(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        ExpenseDTO exprec = masterDataService.getExpenseRefCat(farmondto.getExpenserec().getExpenseRefId(),
                farmondto.getExpenserec().getExpenseType());
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getMaxShopId(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        String maxid = String.valueOf(masterDataService.getMaxShopId());
        ShopDTO shoprec = new ShopDTO();
        shoprec.setShopId(maxid);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String addShopRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int addres = masterDataService.addShopRecord(farmondto.getShoprec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_ADD_RES(addres);
        farmondto.setResponses(farmonres);
        try {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String editShop(String termDTOJSON) throws NamingException{
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int editshop = masterDataService.editShopRecord(farmondto.getShoprec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_EDIT_RES(editshop);
        farmondto.setResponses(farmonres);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getShopForId(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        ShopDTO shoprec = masterDataService
                .getShopNameForId(farmondto.getShoprec().getShopId());
        farmondto.setShoprec(shoprec);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String delShopRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int delres = masterDataService.delShop(farmondto.getShoprec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_DEL_RES(delres);
        farmondto.setResponses(farmonres);
        try {
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getAActiveCropList(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        List<CropDTO> croplist = masterDataService.getActiveCropList();
        farmondto.setCroplist(croplist);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
    ...
    @Path("listCropprodCropid")
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getAllProduct(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        List<CropProductDTO> cropprod = masterDataService.getAllCropprodForCrop(
        farmondto.getCropprodrec().getCropId());
        farmondto.setCropprodlist(cropprod);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
    ...
    @Path("cropprodCropProd")
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getProductForCropProd(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        CropProductDTO cropprod = masterDataService.getCropprodForCropProd(
        farmondto.getCropprodrec().getCropId(), farmondto.getCropprodrec().getProductId());
        farmondto.setCropprodrec(cropprod);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
        } catch (JsonProcessingException ex) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getMaxCropId(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        String maxcropid = String.valueOf(masterDataService.getMaxCropId());
        CropDTO cropdto = new CropDTO();
        cropdto.setCropId(maxcropid);
        farmondto.setCroprec(cropdto);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
        } catch (JsonProcessingException ex) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String addCropRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int addres = masterDataService.addCropRecord(farmondto.getCroprec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_ADD_RES(addres);
        farmondto.setResponses(farmonres);
        try {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String editCropRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int editres = masterDataService.editCropRecord(farmondto.getCroprec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_EDIT_RES(editres);
        farmondto.setResponses(farmonres);
        try {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String delCropRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int delrescrop = masterDataService.delCropRecord(farmondto.getCroprec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_DEL_RES(delrescrop);
        farmondto.setResponses(farmonres);
        try {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getMaxInvId(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        String maxcropid = String.valueOf(masterDataService.getMaxInventoryId());
        InventoryDTO invdto = new InventoryDTO();
        invdto.setInventoryId(maxcropid);
        farmondto.setInventoryrec(invdto);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
        } catch (JsonProcessingException ex) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String addInventoryRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int addres = masterDataService.addInventoryRecord(farmondto.getInventoryrec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_ADD_RES(addres);
        farmondto.setResponses(farmonres);
        try {
    ...
    @Path("lastInvHarForCrop")
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getLastInvHarPerCrop(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
    ...
    @Path("latestInvForCrop")
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getLatestInvForCrop(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        InvDetails invdetails = masterDataService.getLatestInvForCrop(farmondto.getInvdetailsrec().getCropId(), farmondto.getInvdetailsrec().getProductId(),
                farmondto.getInvdetailsrec().getHarvestId());
                              
        farmondto.setInvdetailsrec(invdetails);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
        } catch (JsonProcessingException ex) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getSumInvForCropProdHarvest(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        InventoryDTO invrec = masterDataService.getTotalInvCropProdHar(farmondto.getInventoryrec().getCropId(), farmondto.getInventoryrec().getProductId(),
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getDistinctHarInv(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        List<HarvestDTO> harvestlist = masterDataService.getDistinctHarvInv();
        farmondto.setHarvestlist(harvestlist);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getCropsForHarInv(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        List<CropDTO> croplist = masterDataService.getCropForHarvInv(farmondto.
                getInventoryrec().getHarvestId());
        farmondto.setCroplist(croplist);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
    ...
    @Path("cropprodsForHarCrop")
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getCropprodForHarCrop(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        List<CropProductDTO> cropprodlist = masterDataService.getCropProdForHarvCrop(farmondto.getInventoryrec().getHarvestId(), farmondto.getInventoryrec().getCropId());
        farmondto.setCropprodlist(cropprodlist);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
        } catch (JsonProcessingException ex) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String delInventoryRecord(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int intcropid = masterDataService.delInventoryRecord(farmondto.getInventoryrec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_DEL_RES(intcropid);
        farmondto.setResponses(farmonres);
        try {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getMaxCropProdId(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        String maxcropprodid = String.valueOf(masterDataService.getMaxCropProdId());
        CropProductDTO cropproddto = new CropProductDTO();
        cropproddto.setId(maxcropprodid);
        farmondto.setCropprodrec(cropproddto);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
        } catch (JsonProcessingException ex) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String addCropProductRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int addres = masterDataService.addCropproductRecord(farmondto.getCropprodrec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_ADD_RES(addres);
        farmondto.setResponses(farmonres);
        try {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String editCropProdRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int editres = masterDataService.editCropProdRecord(farmondto.getCropprodrec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_EDIT_RES(editres);
        farmondto.setResponses(farmonres);
        try {
    ...
    @Path("delCropprodCropid")
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String delCropProductCropid(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int cropprodcropid = masterDataService.delCropProductForCropid(farmondto.getCropprodrec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_DEL_RES(cropprodcropid);
        farmondto.setResponses(farmonres);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getNonzeroSales(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        List<SalesDTO> salesrecs = masterDataService.getNonzeroSalesForCrop(
        farmondto.getSalesrec().getCropId());
        farmondto.setSaleslist(salesrecs);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
        } catch (JsonProcessingException ex) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getMaxSalesId(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        String maxsalesid = String.valueOf(masterDataService.getMaxSalesId());
        SalesDTO salesdto = new SalesDTO();
        salesdto.setSalesId(maxsalesid);
        farmondto.setSalesrec(salesdto);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
        } catch (JsonProcessingException ex) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String addSalesRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int addres = masterDataService.addSalesRecord(farmondto.getSalesrec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_ADD_RES(addres);
        farmondto.setResponses(farmonres);
        try {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String editSalesRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int editres = masterDataService.editSalesRecord(farmondto.getSalesrec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_EDIT_RES(editres);
        farmondto.setResponses(farmonres);
        try {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String delSalesRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int cropprodcropid = masterDataService.delSalesRecord(farmondto.getSalesrec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_DEL_RES(cropprodcropid);
        farmondto.setResponses(farmonres);
        try {
    ...
    @Path("lastSalesHarForCrop")
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getLastSalesHarPerCrop(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
    ...
    @Path("latestSalesForCrop")
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getLatestSalesForCrop(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        SalesDTO salesrec = masterDataService.getLatestSalesForCrop(farmondto.getSalesrec().getCropId(), farmondto.getSalesrec().getProdId(),
                farmondto.getSalesrec().getHarvestId());
    ...
    @Path("salesHarCropProd")
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getSalesForCropProdHarvest(String termDTOJSON) throws NamingException, ParseException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getDisBuyerForSales(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getMaxStageId(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        String maxstageid = String.valueOf(masterDataService.getMaxStageId());
        ProductStageDTO stagedto = new ProductStageDTO();
        stagedto.setId(maxstageid);
        farmondto.setProdstagerec(stagedto);
        try {
            String responseTermDTOJSON = objectMapper.writeValueAsString(farmondto);
            return responseTermDTOJSON;
        } catch (JsonProcessingException ex) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String addProdStageRec(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int addres = masterDataService.addProdStageRecord(farmondto.getProdstagerec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_ADD_RES(addres);
        farmondto.setResponses(farmonres);
        try {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String editProdStage(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int editres = masterDataService.editProdStageRecord(farmondto.getProdstagerec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_EDIT_RES(editres);
        farmondto.setResponses(farmonres);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String deleteProdStage(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
...
//            userdto.setResponseCode(HedwigResponseCode.JSON_FORMAT_PROBLEM);            
        ...
        MasterDataServices masterDataService = new MasterDataServices();
        int delres = masterDataService.deleteProdStageRecord(farmondto.getProdstagerec());
        FarmonResponse farmonres = new FarmonResponse();
        farmonres.setFarmon_DEL_RES(delres);
        farmondto.setResponses(farmonres);
        try {
    ...
    @Path("stgCropProdStgid")
    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String getStageForCropProdStageid(String termDTOJSON) throws NamingException {
        ObjectMapper objectMapper = new ObjectMapper();
        FarmonDTO farmondto;
        try {
            Object DTO = objectMapper.readValue(termDTOJSON, FarmonDTO.class);
